...
def ResNet(inp, layers):
    ...
    names = ["conv1_1_3x3_s2",
             ...
             "conv1_3_3x3",
             "conv1_3_3x3_bn"]
    # "conv1_1_3x3_s2" is a convolutional layer with a 3x3 kernel and a stride of 2, 
	# and it's likely the first such layer in the network or in a particular section of the network.
